/**
 * A generic EventManager/ImpactJS plugin implementation for handling events
 * on specific prototypes or instances
 *
 * @author Peter Hildenbrand <peter.hildenbrand@gmail.com>
 * @link https://github.com/peterhildenbrand/impactjsevents
 */
var EventManager = (function () {
     ...
     * 
     * @private
     * @return {EventManager} Returns a new EventManager instance
     */
...
/**
 * The ImpactJS plugin definition
 */
ig.module
(
    'plugins.events'
...
.defines(function () {
    //You may also restrict the eventhandling according to your needs
    //EventManager.apply(ig.Game.prototype);
    //EventManager.apply(ig.Entity.prototype);
    //...
